...
def handle_k5(fullpath, select_filename, tipps_value, root, progressbar):
    ...
    new_ws.cell(row=1, column=7, value=ws[1][6].value)
    ...
    new_ws.cell(row=1, column=8, value=ws[1][7].value)
    new_ws.cell(row=1, column=9, value=ws[1][8].value)
    new_ws.cell(row=1, column=10, value=ws[1][9].value)
    ...
    for i in range(2, maxrow+1):
        ...
        for tracking_no in tracking_nos_list:
            ...
            new_ws.cell(row=new_maxrow + 1, column=7, value=old_row[6].value)
            new_ws.cell(row=new_maxrow + 1, column=8, value=old_row[7].value)
            new_ws.cell(row=new_maxrow + 1, column=9, value=old_row[8].value)
            new_ws.cell(row=new_maxrow + 1, column=10, value=old_row[9].value)
