...
def handle():
    ...
    if radio.get() == 1:
        ...
        result = handle_dhl2(fullpath, select_filename, tipps_value, root, progressbar)
...
if __name__ == '__main__':
    ...
    radio5 = tk.Radiobutton(root, text="DHL(2)", variable=radio, value=5)
    radio5.grid(row=0, column=5, pady=(10, 0))
